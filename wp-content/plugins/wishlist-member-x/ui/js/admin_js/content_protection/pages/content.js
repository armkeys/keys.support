...
var level_action_changed = function() {
	...
	if (operation == 'add_level' || operation == 'remove_level') {
		select.allow_select_all().val("").trigger('change.select2');
	} else {
		select.val("").trigger('change.select2');
	}
...
$.getScript(WLM3VARS.pluginurl + '/ui/js/admin_js/content_protection/posts/payperpost.js?build=3.26.9');