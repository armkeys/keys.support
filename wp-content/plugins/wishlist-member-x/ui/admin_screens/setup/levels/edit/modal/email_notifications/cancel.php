<div class="cancel -holder">
    <div class="row">
        <div class="col-md-12">
            ...
            label : '<?php echo esc_js(__('Enable', 'wishlist-member')); ?>', name : 'cancel_notification',
            type : 'toggle-switch', value: 1, uncheck_value: 0, 
            tooltip : '<?php echo esc_js(__('The Membership Cancelled Notification will be sent to those who are cancelled from a level', 'wishlist-member')); ?>',
            tooltip_size: 'lg'
            }</template>
            <hr>
        </div>
