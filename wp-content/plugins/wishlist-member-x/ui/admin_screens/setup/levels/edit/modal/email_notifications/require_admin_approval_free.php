    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_admin">
            <div class="row">
                <div class="col-md-12">
                    ...
                    label : '<?php echo esc_js(__('Enable', 'wishlist-member')); ?>', name : 'require_admin_approval_free_notification_admin',
                    type : 'toggle-switch', value: 1, uncheck_value: 0,
                    tooltip : '<?php echo esc_js(__('The Global Default Sender Info is located in the Advanced Options > Global Defaults > Email section of WishList Member.', 'wishlist-member')); ?>'
                    }</template>
                    <hr>
                </div>
            </div>
        ...
        <div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_user1">
            <div class="row">
                <div class="col-md-12">
                    <template class="wlm3-form-group">{
                    label : '<?php echo esc_js(__('Enable', 'wishlist-member')); ?>', name : 'require_admin_approval_free_notification_user1',
                    type : 'toggle-switch', value: 1, uncheck_value: 0,
                    tooltip : '<?php echo esc_js(__('The Global Default Sender Info is located in the Advanced Options > Global Defaults > Email section of WishList Member.', 'wishlist-member')); ?>'
                    }</template>
                    <hr>
        ...
        <div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_user2">
            <div class="row">
                <div class="col-md-12">
                    <template class="wlm3-form-group">{
                    label : '<?php echo esc_js(__('Enable', 'wishlist-member')); ?>', name : 'require_admin_approval_free_notification_user2',
                    type : 'toggle-switch', value: 1, uncheck_value: 0,
                    tooltip : '<?php echo esc_js(__('The Global Default Sender Info is located in the Advanced Options > Global Defaults > Email section of WishList Member.', 'wishlist-member')); ?>'
                    }</template>
                    <hr>
