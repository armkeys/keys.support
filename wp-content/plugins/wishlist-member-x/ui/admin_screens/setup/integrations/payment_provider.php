...
<div id="all-integrations-parent" class="show-saving">
    ...
    " data-parent="#all-integrations-parent" id="all-integrations">
        <form action="">
            <div class="row integration-providers pt-3">
                <?php
                // Load providers.
                $providers = glob($this->plugin_dir3 . '/integrations/payments/' . $requested_integration, GLOB_ONLYDIR);

                // This filter will allow third party integrations to add an entry in the Integration >> Payment Providers section of WishList Member.
                $providers = apply_filters('wishlistmember_integration_providers_list', $providers, 'payment_provider');
    ...
    <div id="wlm3-thirdparty-provider">
        ...
        foreach ($thirdparty_providers as $provider) :
            ...
            $_path  = $this->plugin_dir3 . '/integrations/payments/' . $provider;
            ...
            $_path =  apply_filters('wishlistmember_integration_providers_config_path', $_path, $provider, 'payment_provider');
