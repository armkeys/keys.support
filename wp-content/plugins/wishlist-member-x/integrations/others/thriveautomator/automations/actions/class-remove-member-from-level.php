...
/**
 * Remove member from level action class
 */
class Remove_Member_From_Level extends \Thrive\Automator\Items\Action
{
    ...
    {
        return 'wlmta/a/remove-member-from-level';
    }
    ...
    {
        return __('Remove member from membership level', 'wishlist-member');
    }
    ...
    {
        return __('Removes a member from a membership level', 'wishlist-member');
    }
