...
/**
 * User Login action field class
 */
class User_Login extends \Thrive\Automator\Items\Action_Field
{
    /**
    ...
    {
        return __('User Login', 'wishlist-member');
    }
