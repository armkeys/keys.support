<div
    ...
    <div class="body">
        <div class="row -integration-keys">
            ...
            <template class="wlm3-form-group">
                {
                    ...
                    tooltip : '<?php echo esc_js(__('The Infusionsoft by Keap App Name is the beginning of the URL when logged into your account. It is also shown in the Profile > Your Accounts section of Infusionsoft for Keap.', 'wishlist-member')); ?> <em>appname</em>.infusionsoft.com',
                    tooltip_size : 'md',
                    name : 'ismname',
                    column : 'col-md-12',
            ...
            <template class="wlm3-form-group">
                {
                    label : '<?php echo esc_js(__('Encrypted API Key', 'wishlist-member')); ?>',
