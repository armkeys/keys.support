<form>
    ...
    <div class="row">
        <template class="wlm3-form-group">
            {
                label : '<?php echo esc_js(__('Instant Notification URL', 'wishlist-member')); ?>',
                name : 'twocothankyou',
                addon_left : '<?php echo esc_js($wpm_scregister); ?>',
                column : 'col-md-auto',
                class : 'text-center -url',
                group_class : '-url-group',
                help_block : '<?php echo esc_js(__('Use this URL as the Instant Notification URL in 2Checkout.', 'wishlist-member')); ?>',
