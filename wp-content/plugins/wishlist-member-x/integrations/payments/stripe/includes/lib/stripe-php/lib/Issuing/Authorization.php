 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\BalanceTransaction[] $balance_transactions List of balance transactions associated with this authorization.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Issuing\Card $card You can <a href="https://stripe.com/docs/issuing/cards">create physical or virtual cards</a> that are issued to cardholders.
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Issuing\Cardholder $cardholder The cardholder to whom this authorization belongs.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $merchant_data
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $pending_request The pending authorization request. This field will only be non-null during an <code>issuing_authorization.request</code> webhook.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $request_history History of every time the authorization was approved/denied (whether approved/denied by you directly or by Stripe based on your <code>spending_controls</code>). If the merchant changes the authorization by performing an <a href="https://stripe.com/docs/issuing/purchases/authorizations">incremental authorization or partial capture</a>, you can look at this field to see the previous states of the authorization.
 * @property string $status The current status of the authorization in its lifecycle.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Issuing\Transaction[] $transactions List of <a href="https://stripe.com/docs/api/issuing/transactions">transactions</a> associated with this authorization.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $verification_data
 ...
 */
class Authorization extends \WishListMember\PaymentProviders\Stripe\PHPLib\ApiResource
{
