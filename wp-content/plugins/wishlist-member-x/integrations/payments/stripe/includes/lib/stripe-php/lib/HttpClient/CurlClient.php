...
use WishListMember\PaymentProviders\Stripe\PHPLib\Exception;
use WishListMember\PaymentProviders\Stripe\PHPLib\WLM_Stripe;
use WishListMember\PaymentProviders\Stripe\PHPLib\Util;
...
class CurlClient implements ClientInterface
{
    ...
    /**
     * @var \WishListMember\PaymentProviders\Stripe\PHPLib\Util\RandomGenerator
     */
     ...
     * @param null|\WishListMember\PaymentProviders\Stripe\PHPLib\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\WishListMember\PaymentProviders\Stripe\PHPLib\Util\CaseInsensitiveArray $rheaders The response headers</li>
     ...
     * @param integer                                                                        $errno
     * @param integer                                                                        $rcode
     * @param array|\WishListMember\PaymentProviders\Stripe\PHPLib\Util\CaseInsensitiveArray $rheaders
     * @param integer                                                                        $numRetries
     *
     * @return boolean
     */
