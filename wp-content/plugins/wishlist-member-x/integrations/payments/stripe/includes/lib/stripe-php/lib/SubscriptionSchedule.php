 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $default_settings
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Subscription $subscription ID of the subscription managed by the subscription schedule.
 */
