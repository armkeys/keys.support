 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Issuing\Authorization $authorization The <code>Authorization</code> object that led to this transaction.
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Issuing\Card $card The card used to make this transaction.
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Issuing\Cardholder $cardholder The cardholder to whom this transaction belongs.
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $purchase_details Additional purchase information that is optionally provided by the merchant.
 * @property string $type The nature of the transaction.
 */
class Transaction extends \WishListMember\PaymentProviders\Stripe\PHPLib\ApiResource
{
