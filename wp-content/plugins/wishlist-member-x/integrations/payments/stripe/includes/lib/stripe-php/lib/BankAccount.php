 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Customer $customer The ID of the customer that the bank account is associated with.
