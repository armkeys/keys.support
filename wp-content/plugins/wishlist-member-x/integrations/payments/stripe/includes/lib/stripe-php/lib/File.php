 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Collection $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
     ...
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\WishListMember\PaymentProviders\Stripe\PHPLib\Util\Util::flattenParams($params), 1, 0);
