 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $dob
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $relationship
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $verification
 */
class Person extends ApiResource
{
     ...
     *
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\BadMethodCallException
     */
