 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $data
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $request Information on the API request that instigated the event.
