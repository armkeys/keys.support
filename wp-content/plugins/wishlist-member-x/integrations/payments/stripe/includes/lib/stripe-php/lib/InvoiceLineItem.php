 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $metadata Set of <a href="https://stripe.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Note that for line items with <code>type=subscription</code> this will reflect the metadata of the subscription that caused the line item to be created.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $period
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Plan $plan The plan of the subscription, if the line item is a subscription or a proration.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Price $price The price of the line item.
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $tax_amounts The amount of tax calculated per tax rate for this line item
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\TaxRate[] $tax_rates The tax rates which apply to the line item.
