 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $address The customer's address.
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $invoice_settings
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $sources The customer's payment sources, if any.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Customer the updated customer
     */
     ...
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of customer balance transactions
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\CustomerBalanceTransaction
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\AlipayAccount|\WishListMember\PaymentProviders\Stripe\PHPLib\BankAccount|\WishListMember\PaymentProviders\Stripe\PHPLib\BitcoinReceiver|\WishListMember\PaymentProviders\Stripe\PHPLib\Card|\WishListMember\PaymentProviders\Stripe\PHPLib\Source
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of tax ids
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\TaxId
     */
