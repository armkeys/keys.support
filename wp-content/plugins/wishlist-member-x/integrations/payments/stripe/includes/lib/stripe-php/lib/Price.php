 ...
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Product $product The ID of the product this price is associated with.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
