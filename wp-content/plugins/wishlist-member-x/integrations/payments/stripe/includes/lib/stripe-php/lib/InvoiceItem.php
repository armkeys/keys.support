 ...
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $period
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\Price $price The price of the invoice item.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
