 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $company
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $external_accounts External accounts (bank accounts and debit cards) currently attached to this account
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Person $individual <p>This is an object representing a person associated with a Stripe account.</p><p>Related guide: <a href="https://stripe.com/docs/connect/identity-verification-api#person-information">Handling Identity Verification with the API</a>.</p>
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $requirements
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $tos_acceptance
...
class Account extends ApiResource
{
     ...
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Account
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject object containing the response from the API
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of persons
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of capabilities
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Capability
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\BankAccount|\WishListMember\PaymentProviders\Stripe\PHPLib\Card
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\LoginLink
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Person
     */
