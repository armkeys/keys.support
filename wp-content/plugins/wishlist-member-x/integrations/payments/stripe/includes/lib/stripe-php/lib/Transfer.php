 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Account $destination ID of the Stripe account the transfer was sent to.
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Charge $destination_payment If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of transfer reversals
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\TransferReversal
     */
