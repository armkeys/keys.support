...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\EphemeralKey the created key
     */
