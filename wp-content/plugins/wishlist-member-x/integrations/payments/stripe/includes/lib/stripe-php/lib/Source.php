 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $ach_credit_transfer
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $ach_debit
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $acss_debit
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $alipay
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $au_becs_debit
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $bancontact
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $card
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $code_verification
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $eps
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $giropay
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $ideal
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $klarna
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $multibanco
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $p24
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $receiver
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $redirect
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $sepa_credit_transfer
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $sepa_debit
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $sofort
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $source_order
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $three_d_secure
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Source the detached source
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of source transactions
     */
    public function sourceTransactions($params = null, $opts = null)
    {
        $url                   = $this->instanceUrl() . '/source_transactions';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj                   = \WishListMember\PaymentProviders\Stripe\PHPLib\Util\Util::convertToStripeObject($response, $opts);
