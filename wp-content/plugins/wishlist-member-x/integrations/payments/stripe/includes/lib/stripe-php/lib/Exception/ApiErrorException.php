...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|integer                                                                        $httpStatus  the HTTP status code
     * @param null|string                                                                         $httpBody    the HTTP body as a string
     * @param null|array                                                                          $jsonBody    the JSON deserialized body
     * @param null|array|\WishListMember\PaymentProviders\Stripe\PHPLib\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\WishListMember\PaymentProviders\Stripe\PHPLib\ErrorObject
     */
     ...
     *
     * @param null|\WishListMember\PaymentProviders\Stripe\PHPLib\ErrorObject $error
     */
     ...
     *
     * @return null|array|\WishListMember\PaymentProviders\Stripe\PHPLib\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\WishListMember\PaymentProviders\Stripe\PHPLib\Util\CaseInsensitiveArray $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \WishListMember\PaymentProviders\Stripe\PHPLib\ErrorObject} for possible
     * values.
     *
     * @return null|string
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \WishListMember\PaymentProviders\Stripe\PHPLib\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
