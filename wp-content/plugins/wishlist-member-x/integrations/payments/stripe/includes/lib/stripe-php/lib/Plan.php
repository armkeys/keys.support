 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Product $product The product whose pricing this plan determines.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
