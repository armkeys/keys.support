 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $metadata
 * @property string $method
 * @property string $recipient
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $reversals
