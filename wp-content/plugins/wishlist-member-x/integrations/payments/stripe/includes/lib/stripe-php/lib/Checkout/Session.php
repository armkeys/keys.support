...
namespace WishListMember\PaymentProviders\Stripe\PHPLib\Checkout;
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Customer $customer The ID of the customer for this session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the session unless an existing customer was provided when the session was created.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $display_items The line items, plans, or SKUs purchased by the customer. Prefer using <code>line_items</code>.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject $total_details Tax and discount details for the computed total amount.
 */
class Session extends \WishListMember\PaymentProviders\Stripe\PHPLib\ApiResource
{
    ...
    use \WishListMember\PaymentProviders\Stripe\PHPLib\ApiOperations\NestedResource;
     ...
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of items
     */
