...
namespace WishListMember\PaymentProviders\Stripe\PHPLib\Service\Radar;

class EarlyFraudWarningService extends \WishListMember\PaymentProviders\Stripe\PHPLib\Service\AbstractService
{
    /**
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Radar\EarlyFraudWarning
     */
