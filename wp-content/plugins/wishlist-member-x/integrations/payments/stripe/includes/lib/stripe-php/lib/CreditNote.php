 ...
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Customer $customer ID of the customer.
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property string|\WishListMember\PaymentProviders\Stripe\PHPLib\Invoice $invoice ID of the invoice.
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\WishListMember\PaymentProviders\Stripe\PHPLib\Refund $refund Refund related to this credit note.
 ...
 * @property \WishListMember\PaymentProviders\Stripe\PHPLib\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\CreditNote the previewed credit note
     */
     ...
     * @throws \WishListMember\PaymentProviders\Stripe\PHPLib\Exception\ApiErrorException if the request fails
     *
     * @return \WishListMember\PaymentProviders\Stripe\PHPLib\Collection the list of credit note line items
     */
