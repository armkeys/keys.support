        ...
        <div class="paypalps-product-form">
            ...
            <div class="row">
                <div class="col-3 pt-1 -paypalps-recurring">
                    <template class="wlm3-form-group">
                        {
                            label : '<?php echo esc_js(__('1st Trial Period', 'wishlist-member')); ?>',
                ...
                <template class="wlm3-form-group">
                    {
                        label : '<?php echo esc_js(__('1st Trial Amount', 'wishlist-member')); ?>',
            ...
            <div class="row">
                <div class="col-3 pt-1 -paypalps-trial">
                    <template class="wlm3-form-group">
                        {
                            label : '<?php echo esc_js(__('2nd Trial Period', 'wishlist-member')); ?>',
                ...
                <template class="wlm3-form-group">
                    {
                        label : '<?php echo esc_js(__('2nd Trial Amount', 'wishlist-member')); ?>',
