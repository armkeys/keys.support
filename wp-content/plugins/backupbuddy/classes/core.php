...
class backupbuddy_core {
	...
	public static function google_drive_destination_sunset_admin_notice() {
		if ( self::is_gdrive_enabled() ) {
			?>
			<div class="solid-backups-gdrive-notice">
				<div class="solid-backups-icon-holder"><span class="dashicons dashicons-info-outline"></span></div>
				<div class="solid-backups-content-holder">
					<p class="solid-backups-notice-heading"><?php _e( 'Solid Backups will remove support for Google Drive™ destinations on August 1st', 'it-l10n-backupbuddy' ) ?></p>
					<p class="solid-backups-notice-content"><?php _e( 'This site has configured Google Drive as a backup remote destination and action is required. Read more and learn about your next steps on SolidWP.com', 'it-l10n-backupbuddy' ) ?></p>
					<a href="https://go.solidwp.com/notice-google-drive-support-ending"><button class="button button-primary button-no-ml"><?php _e( 'Read more', 'it-l10n-backupbuddy' ) ?></button></a>
				</div>
			</div>
			<?php
			wp_enqueue_style('backups-gdrive-admin-notice');
		}
	}
